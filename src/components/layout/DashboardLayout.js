...
const S = {
  ...
  card:      { backgroundColor: 'var(--hy-bg-card)', border: '1px solid var(--hy-border)' },
...
function NavItem({ to, label, icon, end, collapsed }) {
  return (
    <NavLink
      ...
      onMouseEnter={(e) => { if (!e.currentTarget.dataset.active) e.currentTarget.style.backgroundColor = 'var(--hy-nav-hover-bg)'; e.currentTarget.style.color = 'var(--hy-nav-text-hover)'; }}
      onMouseLeave={(e) => { if (!e.currentTarget.dataset.active) e.currentTarget.style.backgroundColor = ''; }}
    >
      {({ isActive }) => (
        <>
          ...
          {collapsed && (
            <span style={{
              ...
              backgroundColor: 'var(--hy-bg-card)', color: 'var(--hy-text1)', fontSize: 12, fontWeight: 500,
              padding: '4px 10px', borderRadius: 6, whiteSpace: 'nowrap',
              pointerEvents: 'none', opacity: 0, transition: 'opacity 0.15s',
              fontFamily: 'Montserrat, sans-serif', zIndex: 999,
            ...
            <div key={section} style={{ marginBottom: 24 }}>
              {!collapsed && (
                <p style={{
                  ...
                  textTransform: 'uppercase', color: 'var(--hy-nav-section)',
                  padding: '0 12px', marginBottom: 4, fontFamily: 'Montserrat, sans-serif',
                }}>
                  {section}
                </p>
              )}
        ...
        <div style={{ borderTop: '1px solid var(--hy-border)', padding: '10px 8px', flexShrink: 0 }}>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: 'transparent', color: 'var(--hy-nav-section)',
          ...
          <div style={{
            ...
            <div style={{
              ...
              backgroundColor: 'var(--hy-brand)', color: '#fff',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <header style={{
          ...
          <div style={{ flex: 1, maxWidth: 420, position: 'relative' }}>
            <svg
              style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--hy-text4)', pointerEvents: 'none' }}
            ...
            <input
              id="global-search"
              type="text"
              placeholder="Buscar en HellYeah..."
              value={search}
            ...
            <kbd style={{
              ...
              fontSize: 10, color: 'var(--hy-text4)', backgroundColor: 'var(--hy-bg-input)',
              border: '1px solid var(--hy-border2)', borderRadius: 4, padding: '1px 5px',
              fontFamily: 'Montserrat, sans-serif',
            }}>
              Ctrl K
            </kbd>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <button
              style={{
                ...
                cursor: 'pointer', color: 'var(--hy-text3)',
              }}
            ...
            <div ref={profileRef} style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: 8, border: '1px solid var(--hy-border)',
                  backgroundColor: profileOpen ? 'var(--hy-nav-hover-bg)' : 'var(--hy-bg-card)',
                  cursor: 'pointer',
                }}
              ...
              >
                ...
                <span style={{ fontSize: 13, color: 'var(--hy-text1)', fontWeight: 500, maxWidth: 120, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontFamily: 'Montserrat, sans-serif' }}>
                  {user?.email?.split('@')[0]}
                </span>
